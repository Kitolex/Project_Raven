    ...
    case WM_KEYDOWN:
        ...
        switch(wParam)
        {
		 ...
		 case 'W':
		   ...
		   g_pRaven->MoveUp(true);

		   break;

         case 'S':

           g_pRaven->MoveDown(true);
		 ...
		 case 'A':
           ...
           g_pRaven->MoveLeft(true);

           break;

         case 'D':

           g_pRaven->MoveRight(true);
    ...
    case WM_KEYUP:
      {
        switch(wParam)
        {
		 ...
		 case 'W':
		   ...
		   g_pRaven->MoveUp(false);

		   break;

         case 'S':

           g_pRaven->MoveDown(false);
		 ...
		 case 'A':
           ...
           g_pRaven->MoveLeft(false);

           break;

         case 'D':

           g_pRaven->MoveRight(false);
