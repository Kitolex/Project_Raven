...
void Raven_Bot::Move(Vector2D direction){
	GetBrain()->RemoveAllSubgoals();

	GetBrain()->AddGoal_MoveToPosition(m_vPosition + direction);
}

void Raven_Bot::MoveDown(){
	GetBrain()->RemoveAllSubgoals();

	GetBrain()->AddGoal_MoveToPosition(m_vPosition + Vector2D(0, 5));
}

void Raven_Bot::MoveLeft(){
	GetBrain()->RemoveAllSubgoals();

	GetBrain()->AddGoal_MoveToPosition(m_vPosition + Vector2D(-5, 0));
}

void Raven_Bot::MoveRight(){
	GetBrain()->RemoveAllSubgoals();
